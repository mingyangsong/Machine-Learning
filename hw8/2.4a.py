...
def train_NB(train_set, test_set, N):
   ...
   # print "------------------"
    ...
    con_list=[item for item in con_list if item not in rem_list]
    lib_list=[item for item in lib_list if item not in rem_list]
